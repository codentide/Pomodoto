...
export function Select({
  ...
  // Se supone que el aria-componente bloquea el scroll cuando se abre, pero este no lo hace, investigar como cambiar la referencia del body a la que uno quiera desde la librería, mientras... utilizar este hack para cerrar el select cuando se mueva la rueda del ratón
